...
import com.coswick.travelinktrial.adapater_wisata.WisataKlatenAdapter;
import com.coswick.travelinktrial.adapter_image_slide.ImageSlideAcehAdapter;
import com.coswick.travelinktrial.adapter_image_slide.ImageSlideKlatenAdapter;
...
public class WisataKlaten extends AppCompatActivity {
    ...
    private ImageSlideKlatenAdapter slideAdapter;
    private ViewPager viewPager;

    //Deklarasi Tipe Data
    private static final String HI = "https://rasyidridla.000webhostapp.com/TRAVELINK/Klaten/Klaten.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slideAdapter = new ImageSlideKlatenAdapter(WisataKlaten.this);
        viewPager = findViewById(R.id.viewPagerSlide_klaten);
        sliderDotspanel = findViewById(R.id.SliderDots_klaten);
        ...
        for(int i = 0; i < dotscount; i++){
            dots[i] = new ImageView(WisataKlaten.this);
            dots[i].setImageDrawable(ContextCompat.getDrawable(WisataKlaten.this, R.drawable.ic_non_active_dot));
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
            params.setMargins(8, 0, 8, 0);
            sliderDotspanel.addView(dots[i], params);
        }

        dots[0].setImageDrawable(ContextCompat.getDrawable(WisataKlaten.this, R.drawable.ic_active_dot));
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                dots[position].setImageDrawable(ContextCompat.getDrawable(WisataKlaten.this, R.drawable.ic_active_dot));
            }
        ...
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar_klaten);
