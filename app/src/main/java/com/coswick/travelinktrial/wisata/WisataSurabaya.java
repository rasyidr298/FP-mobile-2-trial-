...
import com.coswick.travelinktrial.adapater_wisata.WisataSurabayaAdapter;
...
public class WisataSurabaya extends AppCompatActivity {
    ...
    private ImageSlideSurabayaAdapter slideAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slideAdapter = new ImageSlideSurabayaAdapter(WisataSurabaya.this);
        viewPager = findViewById(R.id.viewPagerSlide_surabaya);
        sliderDotspanel = findViewById(R.id.SliderDots_surabaya);
        ...
        for(int i = 0; i < dotscount; i++){
            dots[i] = new ImageView(WisataSurabaya.this);
            dots[i].setImageDrawable(ContextCompat.getDrawable(WisataSurabaya.this, R.drawable.ic_non_active_dot));
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
            params.setMargins(8, 0, 8, 0);
            sliderDotspanel.addView(dots[i], params);
        }

        dots[0].setImageDrawable(ContextCompat.getDrawable(WisataSurabaya.this, R.drawable.ic_active_dot));
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                dots[position].setImageDrawable(ContextCompat.getDrawable(WisataSurabaya.this, R.drawable.ic_active_dot));
            }
        ...
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar_surabaya);
